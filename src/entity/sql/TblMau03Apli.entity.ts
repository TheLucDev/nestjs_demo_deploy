...
@Index("PK_tblMau03APLI", ["idphieu"], { unique: true })
@Entity("tblMau03APLI", { schema: "dbo" })
export class TblMau03Apli {
  ...
  @Column("nvarchar", { name: "Chucvukhac", nullable: true, length: 50 })
  ...
  @Column("bit", { name: "ChkTuvan", nullable: true })
  chkTuvan: boolean | null;

  @Column("bit", { name: "ChkGTVL", nullable: true })
  chkGtvl: boolean | null;

  @Column("bit", { name: "ChkCULD", nullable: true })
