...
@Index('PK_ttldBaocao', ['idBaocao'], { unique: true })
@Entity('ttldBaocao', { schema: 'dbo' })
export class TtldBaocao {
  @PrimaryGeneratedColumn({ type: 'bigint', name: 'IdBaocao' })
  idBaocao: string;
  ...
  @OneToMany(
    () => TtldBaocaochitiet,
    (ttldBaocaochitiet) => ttldBaocaochitiet.idBaocao,
  )
